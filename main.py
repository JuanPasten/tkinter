...
class mainApp(Tk):
    ...
    def __init__(self):
        ...
        self.geometry("185x150")
        #self.configure(bg = "#123ERF")
        self.resizable(0,0)
    ...
    def createLayout(self):
        ...
        self.rb1 = ttk.Radiobutton(self, text="Faremheit", variable=self.tipoUnidad, value="F", command=self.selected).place(x=20, y=70)
        self.rb2 = ttk.Radiobutton(self, text="Celcius", variable=self.tipoUnidad, value="C", command=self.selected).place(x=20, y=95)
    ...
    def validateTemperature(self, *args):         
        ...
        print("nuevoValor", nuevoValor, "vs valora anterior", self.__temperaturaAnt)
        try:
            float(nuevoValor)
